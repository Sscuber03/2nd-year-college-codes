...
int main()
{
	...
	printf("Sparce matrix representation fo first matrix: \n");
	...
	printf("Sparce matrix representation fo second matrix: \n");
	...
	printf("Sparce matrix representation fo added matrix: \n");
	for (int i = 0; i < k; i++)
	{
		for (int j = 0; j < 3; j++)
		{
